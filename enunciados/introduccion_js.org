...
**** El REPL en el navegador
     Para acceder al REPL en el navegador, accede a las [[https://https://pedroprieto.github.io/post/herramientas-desarrollo/#herramientas-de-desarrollo-de-navegadores][herramientas de desarrollo]] (en la mayoría de los casos se accede pulsando ~F12~). Una vez ahí, selecciona *consola*.
